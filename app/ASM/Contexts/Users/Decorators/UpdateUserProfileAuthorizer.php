...
class UpdateUserProfileAuthorizer extends ASMCommandAuthorizer implements CommandBus {
    ...
    private function setAuthorized($userId)
    {
        ...
        {
            $this->authorized = ['update_user_profile'];
        }
        else
        {
            $this->authorized = ['update_other_users_profile'];
        }
    }
